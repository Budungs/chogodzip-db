# complete 최종 (test) - > GOSIWON 부분 수정
...
while(1):
    ...
    for house in json_data["DATA"]:
        ...
        cursor.execute("""
            INSERT INTO GOSIWON
            (ROOM_ID, TITLE, PRICE_MIN, PRICE_MAX, DEPOSIT_MIN, DEPOSIT_MAX, MAINTENANCE_FEE, GENDER_LIMIT, TYPE, AGE_MAX, AGE_MIN) 
        ...
        """, (
            ...
            maintenance_fee,                       # GENDER_LIMIT
            house_type_cd,     # MAINTENANCE_FEE
            gender_type_cd,             # TYPE
